...
**Problem**: Who should be responsible for answering an input event in the system, generated by the *UI* (User Interface)?
...
- A class that represents the global system, a device or subsystem(*facade controller*).
